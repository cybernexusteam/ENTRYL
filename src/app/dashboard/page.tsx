...
const Dashboard = () => {
 ...
 useEffect(() => {
   ...
   const infoInterval = setInterval(fetchSystemInfo, 100);
   ...
   <AnimatePresence>
     {showContent && (
       <motion.div className="bg-black flex items-center w-full h-screen overflow-hidden">
         ...
         <div className="flex flex-col h-[70vh] mx-[2px]">
           <motion.div
               ...
               <div className="flex w-full gap-6">
                 <div className="flex flex-col gap-6 w-[500px]">
                   ...
                   <div className="w-full h-full p-5 bg-opacity-20 bg-surface0 border-2 border-opacity-20 border-text0 rounded-xl">
                     <motion.h1 className="text-text0 font-extrabold text-4xl w-full flex justify-center">
                       ENTRYL SCAN 🔎
                     </motion.h1>
                     <motion.p className="text-text0 text-lg py-6 w-full flex justify-center">
                       Scan your system for malware, Please select a directory to scan when prompted.
                     </motion.p>
                     <div className="w-full h-full flex justify-center items-center">
                     <Button onClick={handleScanClick} className="mt-4 w-full text-text0 text-xl justify-center items-center">
                       Start Scan
                     </Button>
                     </div>
   ...
   <ResponsiveContainer width="99%" height="100%">
     <LineChart data={memoryData} margin={{ top: 5, right: 5, left: 5, bottom: 5 }}>
       ...
       <Line type="monotone" dataKey="usage" stroke="#82ca9d" dot={false} />
                 ...
                 <div className="w-1/3 h-84 p-5 bg-opacity-20 bg-surface0 border-2 border-opacity-20 border-text0 rounded-xl ">
                   <div className="h-full flex flex-col justify-center">
                   <motion.h1
   initial={{ opacity: 0 }}
   animate={{ opacity: 1 }}
   className="text-text0 font-extrabold text-4xl mb-4 flex justify-center w-full"
 >
   ENTRYL ASSISTANT 👩🏻‍💼
 </motion.h1>
